...
if("TRUE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /home/roskinetic/Observation-learning-Real-world/catkin_ws/src/ros_comm/tools/rosconsole)
  set(rosconsole_DEVEL_PREFIX /home/roskinetic/Observation-learning-Real-world/catkin_ws/devel)
  ...
  set(rosconsole_INSTALL_PREFIX /home/roskinetic/Observation-learning-Real-world/catkin_ws/install)
...
if(NOT "/home/roskinetic/Observation-learning-Real-world/catkin_ws/src/ros_comm/tools/rosconsole/include;/usr/include " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "/home/roskinetic/Observation-learning-Real-world/catkin_ws/src/ros_comm/tools/rosconsole/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roskinetic/Observation-learning-Real-world/catkin_ws/src/ros_comm/tools/rosconsole/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;/usr/lib/x86_64-linux-gnu/liblog4cxx.so;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
