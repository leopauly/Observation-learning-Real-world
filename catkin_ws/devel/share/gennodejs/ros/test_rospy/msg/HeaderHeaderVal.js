...
class HeaderHeaderVal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HeaderVal.serialize(obj.val, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HeaderHeaderVal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [val]
    data.val = HeaderVal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += HeaderVal.getMessageSize(object.val);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HeaderHeaderVal(null);
    ...
    if (msg.val !== undefined) {
      resolved.val = HeaderVal.Resolve(msg.val)
    }
    else {
      resolved.val = new HeaderVal()
    }
