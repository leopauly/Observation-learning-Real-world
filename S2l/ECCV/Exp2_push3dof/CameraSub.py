...
class CameraSub:
    ...
    def camera_subscribe(self):
        ...
        frame_rgb=rospy.Subscriber('/camera/images',Image,self.ros_to_cv2img)
        
        #img_msg = rospy.wait_for_message('/camera/images', Image)     
        #print(img_msg)
        #frame_rgb=self.ros_to_cv2img(img_msg)
