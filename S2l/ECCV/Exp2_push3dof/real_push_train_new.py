...
class RoboControl:
    def __init__(self):
         ...
         self.pub = rospy.Publisher('/robot_command',numpy_msg(Floats), queue_size=10)
    ...
    def publish_control(self,action):
        ...
        self.vel_msg=np.array([action[0],0])
...
def s2l():
    ...
    action_space_high=[0] #[0.0,0.0,0.0]
    action_space_low=[3.14] #[0.5,0.5,0.5]
    ...
    for episode in range(num_episodes):
        ...
        for t in range(num_rollouts):
            ...
            for i in range(steps):
                ...
                rospy.wait_for_message('/robot_done', Int8) 
