...
#frame_feature_size=
demo_folder='./Demos/Demo_real_push_0deg/'
...
class RoboControl:
    def __init__(self):
        ...
        rospy.Subscriber('/robot_done', numpy_msg(Floats),self.callback)
    ...
    def publish_control(self,action):
        ...
        print('before')
        robot_done=rospy.wait_for_message('/robot_done', numpy_msg(Floats))#,timeout=timeout_period) 
        print('after')
